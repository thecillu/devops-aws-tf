/*
 * This file contains the configuration for AWS ACM certificates and Route 53 records.
 * It creates an ACM certificate for the application load balancer and a separate one for the CDN.
 * The certificates are validated using DNS validation method.
*/
